  ...
  return (
    <div className="flex flex-col bg-white rounded-xl">
      <button
        ...
        className="w-full py-2 text-sm text-gray-600 hover:bg-gray-50 transition-colors border-b"
      >
      ...
      <div className="flex flex-col">
        {isHistoryVisible && (
          <div className="overflow-auto" style={{ maxHeight: 'calc(100vh - 65vh)' }}>
            <div className="relative">
              ...
              <div ref={transcriptRef} className="p-4 flex flex-col gap-y-4">
        ...
        <div className="border-t border-gray-200 p-4 flex items-center gap-x-2">
          <input
            ref={inputRef}
            type="text"
            value={userText}
